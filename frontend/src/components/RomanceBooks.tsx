...
import { useGetRomanceBooksQuery } from "../hooks/bookHooks";
import { useState } from "react";

const ITEMS_PER_PAGE = 10;

export default function RomanceBooks() {
  const { isLoading, error, data: books } = useGetRomanceBooksQuery();
  ...
  return isLoading ? (
    ...
    <div className="body-container">
      <div>
        <h1 className="text-center mb-4">Best Selling Romance Books</h1>
        {renderBooks()}
        {renderPagination()}
      </div>
    </div>
