...
import { useGetThrillerBooksQuery } from "../hooks/bookHooks";
import { useState } from "react";

const ITEMS_PER_PAGE = 10;

export default function ThrillerBooks() {
  const { isLoading, error, data: books } = useGetThrillerBooksQuery();
  ...
  return isLoading ? (
    ...
    <div className="body-container">
      <div>
        <h1 className="text-center mb-4">Best Selling Thriller Books</h1>
        {renderBooks()}
        {renderPagination()}
      </div>
    </div>
